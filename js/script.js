...
const starsTexture = loader.load('https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/stars.jpg');
scene.background = starsTexture;

// Create celestial bodies
const sunGeometry = new THREE.SphereGeometry(8, 32, 32);
const sunMaterial = new THREE.MeshBasicMaterial({ map: loader.load('https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/sun.jpg') });
const sun = new THREE.Mesh(sunGeometry, sunMaterial);
scene.add(sun);

const mercury = createPlanet(2, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/mercury.jpg', "mercury");
const venus = createPlanet(3.8, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/venus.jpg', "venus");
const earth = createPlanet(4, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/earth.jpg', "earth");
const mars = createPlanet(2, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/mars.jpg', "mars");
const jupiter = createPlanet(12, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/jupiter.jpg', "jupiter");
const saturn = createPlanet(10, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/saturn.jpg', "saturn", true); // Saturn has a ring
const uranus = createPlanet(7, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/uranus.jpg', "uranus");
const neptune = createPlanet(6.5, 'https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/neptune.jpg', "neptune");
...
function createPlanet(size, textureUrl, name, hasRing = false) {
  ...
  if (hasRing) {
    ...
    const ringMaterial = new THREE.MeshBasicMaterial({
      map: loader.load('https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/saturn_ring.png'),
...
window.onload = function() {
  ...
  loadingScreen.style.backgroundImage = "url('https://raw.githubusercontent.com/cdmain/3D-Solar-System-Simulation/main/img/background.jpg')";
